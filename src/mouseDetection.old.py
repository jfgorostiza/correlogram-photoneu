#
# Este programa captura imágenes con la cámara y realizar varias operaciones morfológicas para la detección de contornos.
# Dibuja un círculo en el centro de un ratón detectado.
